...
<body>
    ...
    <main role="main">
        ...
        <section class="album py-3">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 text-center function" data-function="case_studies">
                            <div class="card-body">
                                <i class="fas fa-chalkboard-teacher fa-3x" style="color: #fff;"></i>
                                <p class="card-text">Case studies</p>
                            </div>
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="card mb-4 text-center function" data-function="events">
                            <div class="card-body">
                                <i class="fas fa-calendar-alt fa-3x" style="color: #fff;"></i>
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4 text-center function" data-function="partners">
                            <div class="card-body">
                                <i class="fas fa-address-card fa-3x" style="color: #fff;"></i>
                                <p class="card-text">Partners</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="sections">
                                    ...
                                    <div class="tab-pane fade show active" id="list-prog_lang" role="tabpanel"
                                        ...
                                        <ul class="list-group mb-3">
                                            ...
                                            <li class="tech list-group-item
                                                ...
                                                data-url="https://www.postgresql.org">
                                                PostgreSQL 9.6.11
                                                <span class="badge
                                                        badge-primary
                                    ...
                                    <div class="tab-pane fade" id="list-design" role="tabpanel"
                                        ...
                                        <ul class="list-group mb-3">
                                            <li class="tech list-group-item
                                                    ...
                                                    justify-content-between
                                                    align-items-center" title="See more"
                                                data-url="https://getbootstrap.com/">
                                                Bootstrap v4.1.2
                                                <span class="badge
                                                        badge-primary
                                                        badge-pill">MIT License</span>
                                            ...
                                            <li class="tech list-group-item
                                                    ...
                                                    justify-content-between
                                                    align-items-center" title="See more"
                                                data-url="https://fontawesome.com/">
            ...
            <div id="help" class="container only-one">
                ...
                <div class="row mb-3 justify-content-center">
                    ...
                    <div class="col-md-12 mb-3">
                        <h4 class="d-flex justify-content-between
                                    align-items-center mb-3">
                            <span class="text-muted">User guide</span>
                        </h4>
                    </div>

                    <div class="col-md-2">
                        <div class="media pt-3 user_guide">
                            <span class="badge badge-pill mr-2 px-2 py-2" data-function="User_guide.pdf"
                                title="Download User guide" style="background-color:#007bff; color:white"><i
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                <h5>Basic Search - First steps</h5>
                                </p>
                                <div class="d-flex justify-content-between
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn
                                                ...
                                                watch-video" data-title="Basic Search - First steps"
                                            data-video="https://www.youtube.com/embed/kSskXhy7j-Q">View</button>
                                    </div>
                                    <small class="text-muted">6 mins 27 sec</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn
                                                btn-sm btn-outline-secondary
                                                watch-video" data-title="Contribution display"
                                            data-video="https://www.youtube.com/embed/vxgxbanWnRY">View</button>
                                    </div>
                                    <small class="text-muted">4 mins 20 sec</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn
                                                btn-sm btn-outline-secondary
                                                watch-video" data-title="KWIC display"
                                            data-video="https://www.youtube.com/embed/jz7rCjTkc2k">View</button>
                                    </div>
                                    <small class="text-muted">5 mins 7 sec</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn
                                                btn-sm btn-outline-secondary
                                                watch-video" data-title="Advanced Search"
                                            data-video="https://www.youtube.com/embed/OdUCaS1tOsI">View</button>
                                    </div>
                                    <small class="text-muted">5 mins 11 sec</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between
                                    ...
                                    <div class="btn-group">
                                        <button type="button" class="btn
                                                btn-sm btn-outline-secondary
                                                watch-video" data-title="Explore by wordcloud"
                                            data-video="https://www.youtube.com/embed/hMocxyHcRrE">View</button>
                                    </div>
                                    <small class="text-muted">5 mins 15 sec</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="case_studies" class="container only-one">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-12">
                        <p>
                            Download here a number of sample case studies that exemplify the different ways this site’s
                            tools may be used and their results interpreted to help answer research questions about the
                            way parliamentarians discuss topics relevant to their governance of the UK.
                        </p>
                        <p>
                            We are working on developing the range of topics covered in these case studies. If you would
                    ...
                    <div class="col-md-2">
                        <div class="media pt-3 case_study">
                            <span class="badge badge-pill mr-2 px-2 py-2" data-function="Austerity.pdf"
                                title="Download Austerity case study" style="background-color:#007bff; color:white"><i
                                    class="fas fa-file-download fa-lg"></i></span>
                            <p class="media-body pb-3 mb-0 lh-125 ">
                                Austerity
                            </p>
                    ...
                    <div class="col-md-2">
                        <div class="media pt-3 case_study">
                            <span class="badge badge-pill mr-2 px-2 py-2" data-function="Peterloo.pdf"
                                title="Download Peterloo case study" style="background-color:#e83e8c; color:white"><i
                                    class="fas fa-file-download fa-lg"></i></span>
                            <p class="media-body pb-3 mb-0 lh-125 ">
                                Peterloo
                            </p>
            ...
            <div id="events" class="container only-one">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mb-3 justify-content-center">
                            ...
                            <!--
                                <div class="media pt-3 col-4 border-right
                                    border-gray">
                                    <svg class="bd-placeholder-img mr-2
                                        ...
                                        ><rect
                                            ...
                                            fill="#e83e8c"></rect><text
                                            x="50%" y="50%" fill="#e83e8c"
                                            dy=".3em">32x32</text></svg>
                                    <p class="pr-3 mr-0">
                                        <strong class="d-block
                                            text-gray-dark">When</strong>
                                        11th December 2019
                                        <strong class="d-block
                                            text-gray-dark">Where</strong>
                                        Leeds, University of Leeds
                                        <strong class="d-block
                                            text-gray-dark">Time</strong>
                                        11.00-12.00
                                        <br>
                                        <a class="btn workshop2 mt-2"
                                            href="https://cde.leeds.ac.uk/events/hansard-as-a-research-tool-finding-patterns-making-links/"
                            ...
                            <div class="media pt-3 col-4">
                                ...
                                <p class="pr-3 mr-0">
                                    ...
                                    1pm-2pm
                                    <br>
                                    <a class="btn workshop3 mt-2"
                                        href="https://www.eventbrite.com/e/epq-workshop-using-hansard-at-huddersfield-registration-123156326889">Register</a>
            ...
            <div id="about_us" class="container only-one">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3">
                        <h4 class="d-flex justify-content-between
                                align-items-center mb-3">
                            <span id="address" class="text-muted">Address</span>
                        </h4>
                        <div class="row">
                            <div class="col-12">
                                <address>
            ...
            <div id="partners" class="container only-one">
                ...
                <div class="row justify-content-center">
                    <div class="row">
                        <div class="col-lg-4 text-center">
                            ...
                            <p>We are working with the <a href="https://hellenicocrteam.gr/" target="_blank">Hellenic
                                    OCR Team</a>, which is a crowd-sourced project aimed at digitising proceedings in
                                the Greek parliament. Our Principal Investigator, Lesley Jeffries, and Hellenic OCR Team
                                Co-Founders George Mikros and Fotis Fitsilis have agreed on the exchange of knowhow,
                                methods and code to jointly tackle common challenges that are related not only to data
                                ...
                                announcements and scientific publications in the area of computational linguistics.</p>
                        </div>
                        <div class="col-lg-4 text-center">
                            ...
                            <p>We have been working in partnership with Hansard in Westminster from the outset. We have
                                had the support and cooperation of the editors and their staff in accessing the Hansard
                        ...
                        <div class="col-lg-4 text-center">
                            ...
                            <p><a href="https://www.historyofparliamentonline.org/" target="_blank">The History of
                                    Parliament Trust</a> has been one of our key supporters and has communicated with
                                its networks about the website. They have attended end-user meetings, given us feedback
                                about the site and co-organised a workshop to introduce new end-users to the site.</p>
                        </div>
                    </div>
                </div>
